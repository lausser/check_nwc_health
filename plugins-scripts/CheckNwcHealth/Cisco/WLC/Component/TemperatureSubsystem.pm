package CheckNwcHealth::Cisco::IOS::Component::TemperatureSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('CISCO-ENVMON-MIB', [
      ['temperatures', 'ciscoEnvMonTemperatureStatusTable', 'CheckNwcHealth::Cisco::IOS::Component::TemperatureSubsystem::Temperature'],
  ]);
}

package CheckNwcHealth::Cisco::IOS::Component::TemperatureSubsystem::Temperature;
...
sub finish {
  ...
  if (! exists $self->{ciscoEnvMonTemperatureStatusValue}) {
    bless $self, 'CheckNwcHealth::Cisco::IOS::Component::TemperatureSubsystem::Temperature::Simple';
  }
}
...
package CheckNwcHealth::Cisco::IOS::Component::TemperatureSubsystem::Temperature::Simple;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
use strict;
