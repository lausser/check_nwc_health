package CheckNwcHealth::Lancom::LCOSSX::Component::SensorSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('SW-MIB', [
      ['sensors', 'swSensorTable', 'CheckNwcHealth::Lancom::LCOSSX::Component::SensorSubsystem::Sensor'],
  ]);
}

package CheckNwcHealth::Lancom::LCOSSX::Component::SensorSubsystem::Sensor;
