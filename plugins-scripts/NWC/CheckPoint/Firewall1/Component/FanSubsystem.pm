package NWC::CheckPoint::Firewall1::Component::FanSubsystem;
...
sub init {
  ...
  foreach ($self->get_snmp_table_objects(
    ...
    push(@{$self->{fans}},
        NWC::CheckPoint::Firewall1::Component::FanSubsystem::Fan->new(%{$_}));
  }
}
...
package NWC::CheckPoint::Firewall1::Component::FanSubsystem::Fan;
our @ISA = qw(NWC::CheckPoint::Firewall1::Component::FanSubsystem);
