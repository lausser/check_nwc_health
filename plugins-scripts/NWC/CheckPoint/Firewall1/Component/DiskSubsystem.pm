package NWC::CheckPoint::Firewall1::Component::DiskSubsystem;
our @ISA = qw(NWC::CheckPoint::Firewall1::Component::EnvironmentalSubsystem);
...
sub init {
  ...
  foreach ($self->get_snmp_table_objects(
    ...
    push(@{$self->{volumes}}, 
        NWC::CheckPoint::Firewall1::Component::DiskSubsystem::Volume->new(%{$_}));
  }
  foreach ($self->get_snmp_table_objects(
      'CHECKPOINT-MIB', 'disksTable')) {
    push(@{$self->{disks}}, 
        NWC::CheckPoint::Firewall1::Component::DiskSubsystem::Disk->new(%{$_}));
  }
...
package NWC::CheckPoint::Firewall1::Component::DiskSubsystem::Volume;
our @ISA = qw(NWC::CheckPoint::Firewall1::Component::DiskSubsystem);
...
package NWC::CheckPoint::Firewall1::Component::DiskSubsystem::Disk;
our @ISA = qw(NWC::CheckPoint::Firewall1::Component::DiskSubsystem);
