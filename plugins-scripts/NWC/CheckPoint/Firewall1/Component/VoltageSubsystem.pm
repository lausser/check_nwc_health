package NWC::CheckPoint::Firewall1::Component::VoltageSubsystem;
...
sub init {
  ...
  foreach ($self->get_snmp_table_objects(
    ...
    push(@{$self->{voltages}},
        NWC::CheckPoint::Firewall1::Component::VoltageSubsystem::Voltage->new(%{$_}));
  }
}
...
package NWC::CheckPoint::Firewall1::Component::VoltageSubsystem::Voltage;
our @ISA = qw(NWC::CheckPoint::Firewall1::Component::VoltageSubsystem);
