package NWC::Fortigate::Component::EnvironmentalSubsystem;
...
sub init {
  ...
  $self->{sensor_subsystem} =
      NWC::Fortigate::Component::SensorSubsystem->new(%params);
  $self->{disk_subsystem} =
      NWC::Fortigate::Component::DiskSubsystem->new(%params);
}
