package NWC::Fortigate::Component::SensorSubsystem;
our @ISA = qw(NWC::Fortigate::Component::EnvironmentalSubsystem);
...
sub init {
  ...
  foreach ($self->get_snmp_table_objects(
    ...
    push(@{$self->{sensors}}, 
        NWC::Fortigate::Component::SensorSubsystem::Sensor->new(%{$_}));
  }
}
...
package NWC::Fortigate::Component::SensorSubsystem::Sensor;
our @ISA = qw(NWC::Fortigate::Component::SensorSubsystem);
