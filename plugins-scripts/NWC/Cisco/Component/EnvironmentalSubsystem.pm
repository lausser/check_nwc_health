package NWC::Cisco::Component::EnvironmentalSubsystem;
...
sub init {
  ...
  # 
  $self->{fan_subsystem} =
      NWC::Cisco::Component::FanSubsystem->new(%params);
  $self->{temperature_subsystem} =
      NWC::Cisco::Component::TemperatureSubsystem->new(%params);
  $self->{powersupply_subsystem} = 
      NWC::Cisco::Component::SupplySubsystem->new(%params);
  $self->{voltage_subsystem} =
      NWC::Cisco::Component::VoltageSubsystem->new(%params);
}
