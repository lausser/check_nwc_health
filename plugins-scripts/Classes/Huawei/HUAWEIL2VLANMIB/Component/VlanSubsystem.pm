package Classes::Huawei::HUAWEIL2VLANMIB::Component::VlanSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('HUAWEI-L2VLAN-MIB', [
      ['vlans', 'hwL2VlanMIBTable', 'Classes::Huawei::HUAWEIL2VLANMIB::Component::VlanSubsystem::Vlan'],
  ]);
}


package Classes::Huawei::HUAWEIL2VLANMIB::Component::VlanSubsystem::Vlan;
