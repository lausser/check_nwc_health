...
sub init {
  ...
  # 
  $self->{fan_subsystem} =
      Classes::Cisco::IOS::Component::FanSubsystem->new();
  $self->{temperature_subsystem} =
      Classes::Cisco::IOS::Component::TemperatureSubsystem->new();
  $self->{powersupply_subsystem} = 
      Classes::Cisco::IOS::Component::SupplySubsystem->new();
  $self->{voltage_subsystem} =
      Classes::Cisco::IOS::Component::VoltageSubsystem->new();
}
